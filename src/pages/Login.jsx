...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(err.normalizedMessage || 'Login failed. Check your credentials.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel — brand */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-600 via-brand-700 to-teal-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold leading-tight">Never miss a dose again.</h2>
            <p className="text-white/80 text-lg leading-relaxed max-w-md">
              Manage medications, scan prescriptions with AI, and get timely reminders — all in one beautiful dashboard.
            </p>
            <div className="space-y-3 pt-4">
              {['Smart medication reminders', 'AI-powered prescription scanning', 'Low stock alerts & tracking'].map((f) => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
            ...
            <p className="text-slate-500 mb-6">Sign in to your Medora account</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {loading ? <Spinner size={20} /> : <>Sign in <ArrowRight className="w-4 h-4" /></>}
              </button>
            </form>
